...
class Form extends Component {
    ...
    componentWillMount() {
        ...
        var { Id,
            ...
            Language,
            AreaId,
            Status, Password } = this.props.user;
    ...
    validate() {
        ...
        if (UserId === '') {
            this.setState({
                error: 'Vui lòng nhập UserId'
            })
            return false
        }
        if (UserId.length < 6) {
            this.setState({
                error: 'UserId phải nhiều hơn 6 ký tự'
            })
            return false
        }
        if (Email === '') {
    ...
    onSave(e) {
        ...
        if (Avatar == this.props.user.Avatar) {
            Avatar = ''
        }
        else {
                    ...
                    <div className={isFetching ? "card-body whirl sphere" : "card-body"}>
                        <form onSubmit={this.onSave} data-parsley-validate="" noValidate className="form-horizontal">
                            <div className="panel panel-default">
                                ...
                                <fieldset>
                                    <FormGroup row>
                                        <label className="col-md-3 col-form-label text-right">UserId</label>
                                        <div className="col-md-6">
                                            <Input
                                                type="text"
                                                name="UserId"
