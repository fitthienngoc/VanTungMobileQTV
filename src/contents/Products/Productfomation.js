...
class Form extends Component {
    ...
    showListFollowing = () => {
        var { userFollowing } = this.props.user
        var result = <p>Chưa tham gia team</p>
        if (userFollowing.length > 0) {
            result = userFollowing.map((item, index) => {
                return (
                    <div key={index + 's'}>
    ...
    showListJoining = () => {
        ...
        var { userJoining } = this.props.user
        var result = <p>Chưa tham gia team</p>
        if (userJoining.length > 0) {
            result = userJoining.map((item, index) => {
                return (
                    <div key={index + 's'}>
                        <div className="media align-items-center">
                            {item.Logo ? <a className="mr-2" href="#"> <img className="rounded-circle img-thumbnail thumb48" src={item.Logo} alt="Contact" /></a> : ''}
                            ...
                            <Card color="dark" className="text-white mb-3">
                                ...
                                <CardBody>
                                    ...
                                    <ul className="list-unstyled px-4">
                                        ...
                                        <li> <em className="fa fa-italic fa-fw mr-3"></em>{UserId}</li>
                                        <li> <em className="fa fa-user fa-fw mr-3"></em>{Gender == 0 ? 'Nữ' : 'Nam'}</li>
