...
class Form extends Component {
    ...
    componentWillMount() {
        ...
        var { Id,
            ...
            Language,
            AreaId,
            Status, Password } = this.props.order;
    ...
    validate() {
        ...
        if (OrderId === '') {
            this.setState({
                error: 'Vui lòng nhập OrderId'
            })
            return false
        }
        if (OrderId.length < 6) {
            this.setState({
                error: 'OrderId phải nhiều hơn 6 ký tự'
            })
            return false
        }
        if (Email === '') {
    ...
    onSave(e) {
        ...
        if (Avatar == this.props.order.Avatar) {
            Avatar = ''
        }
        else {
                    ...
                    <div className={isFetching ? "card-body whirl sphere" : "card-body"}>
                        <form onSubmit={this.onSave} data-parsley-validate="" noValidate className="form-horizontal">
                            <div className="panel panel-default">
                                ...
                                <fieldset>
                                    <FormGroup row>
                                        <label className="col-md-3 col-form-label text-right">OrderId</label>
                                        <div className="col-md-6">
                                            <Input
                                                type="text"
                                                name="OrderId"
                                ...
                                <fieldset>
                                    <FormGroup row>
                                        <div className="col-sm-3 text-right">
                                            <Link to="/orders" className="btn btn-square btn-default">Back</Link>
                                        </div>
