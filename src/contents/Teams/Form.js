...
class Form extends Component {
    ...
    render() {
        ...
        var { error_srv, isFetching, countrys,onCropImg,isCropImg,onCropImgSuccess,Image } = this.props;
        console.log(this.props)
        return (
            <ContentWrapper>
                    ...
                    <div className={isFetching ? "card-body whirl sphere" : "card-body"}>
                        <form onSubmit={this.onSave} data-parsley-validate="" noValidate className="form-horizontal">
                            <div className="panel panel-default">
                                ...
                                <fieldset>
                                    <FormGroup row>
                                        <label className="col-md-3 col-form-label text-right">Team's Email</label>
                                        <div className="col-md-6">
                                            <Input
                                                required="required"
                                                data-parsley-required-message="Field must have a valid."
                                ...
                                <fieldset>
                                    <FormGroup row>
                                        <label className="col-md-3 col-form-label text-right">Team's Logo</label>
                                        <div className="col-md-6">
                                            <CropIMG onCropImg={onCropImg} isCropImg={isCropImg} aspect={4/4} Image={Image} onCropImgSuccess={onCropImgSuccess} />
                                        </div>
                                    </FormGroup>
                                </fieldset>
                                ...
                                <fieldset>
                                    <FormGroup row>
                                        <div className="col-sm-3 text-right">
                                            <Link to="/team" className="btn btn-square btn-default">Back</Link>
                                        </div>
