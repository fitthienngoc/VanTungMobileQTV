...
class Form extends Component {
    ...
    componentWillMount() {
        ...
        var { Id,
            TargetType, Title, Image, error, TargetId, LinkWeb, TypeEvent,
            TypeTeam,
            TypeVenue, TypeMain, Comments
        } = this.props.banner;
        ...
        LinkWeb ? LinkWeb = LinkWeb : LinkWeb = '';
        Comments ? Comments = Comments : Comments = '';


        this.setState({
            Id,
            Title, Image, error, TargetId, LinkWeb, TypeMain,
            TypeEvent,
            TypeTeam,
            TypeVenue, Comments
        });
    ...
    onSave(e) {
        ...
        e.preventDefault();
        var { Id, Title, Image, LinkWeb, TypeEvent, TypeTeam, TypeVenue, TypeMain, Comments } = this.state;
        ...
        var banner = {
            Id, Title,
            BannerLink: LinkWeb,
            TypeEvent, TypeTeam, TypeVenue, TypeMain,
            Image, Comments
        };
    ...
    render() {
        ...
        var {
            Id,
            TargetType, Title, error, TargetId, valueEvent, valueVenue, valueTeam, team, TypeEvent, TypeTeam, TypeMain, TypeVenue, venue, event, LinkWeb, Comments } = this.state;
                    ...
                    <div className={isFetching ? "card-body whirl sphere" : "card-body"}>
                        <form onSubmit={this.onSave} data-parsley-validate="" noValidate className="form-horizontal">
                            <div className="panel panel-default">
                                ...
                                <fieldset>
                                    <FormGroup row>
                                        <label className="col-md-3 col-form-label text-right">Link</label>
                                        <div className="col-md-6">
                                            <Input
                                                required="required"
                                                data-parsley-required-message="Field must have a valid."
                                ...
                                {/* <fieldset>
                                    ...
                                    <FormGroup row>
                                        <label className="col-md-3 col-form-label text-right">Period</label>
                                        <Row>
                                            <div className="col-md-6">
                                                <Col>
                                                    <Datetime onChange={(value)=>console.log(value)} inputProps={{ className: 'form-control' }} />
                                                </Col>
                                            </div>
                                            <div className="col-md-6">
                                                <Col>
                                ...
                                <fieldset>
                                    <FormGroup row>
                                        <label className="col-md-3 col-form-label text-right">Comments</label>
                                        <div className="col-md-6">
                                            <Input
                                                required="required"
                                                data-parsley-required-message="Field must have a valid."
